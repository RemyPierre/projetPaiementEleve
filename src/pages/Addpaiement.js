...
const AddPaiement=()=> {
  ...
  const[eleve_id,setEleve_id]=useState(eleve.id)
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="Listeinactif" tabindex="-1" >PAIEMENT</a>
          </li>
        </ul>
      </div>
    </div>
             ...
             <tr><th>ID</th>
               ...
               <th>view</th>
                ...
                {eleve.map(eleve=>(
                 ...
                 <td>    < AjouterPaiement eleve={eleve}/></td>
                 <td>  <ListePaiementEleve eleve={eleve}/></td>
